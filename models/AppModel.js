var AppModel = Backbone.Model.extend({
    ...
    initialize: function () {
        this.set('current_URL', 'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q=numberphile&type=video&key=AIzaSyD5dy-5GDx7outd6JdIGjjRFJxmkKKBmrw');
