var VideosCollection = Backbone.Collection.extend({
  ...
  /* URL explanation:
   the 'search?' part of the url specifies that we want a result that matches a search parameter
   the 'part=snippet' returns an object that contains the details of the search (title, description, thumbnail)
   'max results' is set at 4 because we want to have 4 videos in our collection to display on the page, this may change based on extensions
   'q=' is where we put our search input variable, it is set to dogs so we have an inital search to show on page load
