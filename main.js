...
var AppModel = Backbone.Model.extend({
  ...
  updateUrl: function () {
    // this.url = 'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=' + this.get('search_query') + '&type=video&videoEmbeddable=true&key=AIzaSyCOM9jNQ7zNmFDe7KPa3xoZ1KKCRrOp9oA';
