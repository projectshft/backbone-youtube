...
$('.search-button').on('click', function () {
  ...
  // // $('#video-search').val('');
  // fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyBG5b1D7dEBXFY0PgaKlMSFBcV3rNA7A8w&q=searchTerm`).then(function(response) {
  //   return response.json();
  // })
  // .then(function(data) {
  //   renderSideVideos(data);
  //   console.log(data);
  // });
});
