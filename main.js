...
//USED SAMPLE DATE BELOW TO VISUALIZE AND FIGURE OUT HOW TO GET RELEVANT DATA
// var sampleData = {
...
// var converted = JSON.stringify(sampleData);
// var data = JSON.parse(converted);

// var test = {
//   title: data.items[0].snippet.title,
//   description: data.items[0].snippet.description,
//   id: data.items[0].snippet.videoId,
//   smallUrl: data.items[0].snippet.thumbnails.default.url,
//   bigUrl: data.items[0].snippet.thumbnails.high.url,
// };
